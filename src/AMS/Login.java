...
public class Login extends JFrame implements ActionListener {
    ...
    JTextField tf;
    JFrame f;
    JCheckBox showPasswordCheckBox; // New checkbox for show password
    ...
    Login() {
        ...
        gradientPanel.setBounds(0, 0, 580, 400); // Increased height to accommodate new element
        f.add(gradientPanel);
...
ah
        ...
        showPasswordCheckBox.setBounds(320, 210, 150, 20);
        ...
        showPasswordCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (showPasswordCheckBox.isSelected()) {
                    // Show password
                    pf.setEchoChar((char) 0); // Set echo char to 0 to show plain text
                } else {
                    // Hide password
                    pf.setEchoChar('•'); // Set echo char back to bullet
                }
            }
        });
        l1.add(showPasswordCheckBox);
        ...
        bt1.setBounds(120, 250, 150, 40); // Adjusted position
        l1.add(bt1);
        ...
        bt2.setBounds(320, 250, 150, 40); // Adjusted position
        l1.add(bt2);
        ...
        // === Frame Settings ===
        f.setSize(580, 400); // Increased height
        f.setLocation(400, 200);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        // Enable maximize and resizable
        f.setResizable(true);
        f.setVisible(true); 
    }
