...
public class CancelFlight extends JFrame implements ActionListener, ItemListener {
    ...
    // --- Components ---
    ShadowLabel l_title, l_ticket, l_source, l_dest, l_class, l_price, l_flightCode, l_journeyTime, l_journeyDate, l_username, l_name, l_reason;
    PillButton bt_cancel, bt_back;
    JTextField tf_source, tf_dest, tf_class, tf_price, tf_flightCode, tf_journeyTime, tf_journeyDate, tf_username, tf_name, tf_reason;
    ...
    public CancelFlight() {
        ...
        l_reason.setBounds(col1_x, y_pos, label_w + 20, 30);
        l1.add(l_reason);
        ...
        tf_reason.setBounds(col1_x + label_w + 20, y_pos, formWidth - 120, field_h);
        ...
        try {
            ...
            if (updated > 0) {
                ...
                String insertQuery = "INSERT INTO cancel (" +
                    "ticket_id, source, destination, class_name, price, " +
                ...
                pstInsert.setString(6, flightCode);
                pstInsert.setString(7, username);
                pstInsert.setString(8, passengerName);
                pstInsert.setString(9, age);
                pstInsert.setString(10, dob);
                pstInsert.setString(11, passport);
                pstInsert.setString(12, journeyTime);
                pstInsert.setString(13, journeyDate);
                pstInsert.setString(14, reason);
                pstInsert.setString(15, "Pending");
                pstInsert.setString(16, calculateRefundAmount(price));
